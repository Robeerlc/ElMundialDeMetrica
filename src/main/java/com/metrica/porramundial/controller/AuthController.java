                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <p>Tu cuenta está lista para usar en la plataforma oficial de <span class="highlight">METRICA</span>.</p>
                            <div class="info-box">
                            ...
                            <p style="margin-top: 2rem; font-size: 13px; color: #6e7681;">¡Que disfrutes del torneo! 🏆</p>
                        </div>
                        <div class="footer">
                            <p>© 2026 METRICA Global. Todos los derechos reservados.</p>
                        </div>
                    </div>
                </body>
                </html>
